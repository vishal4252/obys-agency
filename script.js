...
function sheryAnimation() {
    // It check the device width for shery js animation if it is >=768px then it will call the gooeyAnimation fun otherwise not.....
